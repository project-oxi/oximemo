...
> Canonical unified design system: `project-oxi/.github/DESIGN.md` — this file is a project-local snapshot of the design system generated by design-farmer Phase 4.5 (predates canonical consolidation).
